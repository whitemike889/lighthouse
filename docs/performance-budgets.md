...
Use a [performance budget](https://addyosmani.com/blog/performance-budgets/) to assert thresholds for performance metrics. `budget.json` supports three types of budgets:
